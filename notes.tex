...
\begin{definition}
  ...
  \end{align*}
\end{definition}
\note{This definition is good, he also gives another one in terms of pullback,
do we want that?}
...
\begin{example}
  ...
  \begin{proof}
    ...
    \missingproof
    \note{This is a sketch, I think it would be good to clarify some points, 
    i.e. the isomorphism to the product, and the disjoint union with the epsilon stuff}
  \end{proof}
\end{example}
...
\end{definition}
\note{fix to normal restriction map notation or whatever.. altho i think this is clearer}
...
\end{nonexample}
\note{doublecheck if exp $1/2$ is the correct map!}
