...
\missingexample
\emph{I think adding more concrete examples would be good, for me at least, TODO}
...
\end{align*}
In particular, the square root function can be described as the map $\sigma  : \mathbb{R} \to \mathbb{R}$ such that for every  $u \in U$ we have $\sigma(u)^2 = u$.
\end{example}
